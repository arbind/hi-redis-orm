...
(function() {
  ...
  hiModelBase = (function() {
    ...
    hiModelBase.prototype._attributes = null;

    hiModelBase.prototype._refs = null;

    hiModelBase.extend = function(module) {
      var key, value, _ref;
      for (key in module) {
        value = module[key];
    ...
    hiModelBase.include = function(module) {
      var key, value, _ref;
      for (key in module) {
        value = module[key];
        if (__indexOf.call(mixinKeywords, key) < 0) {
    ...
    function hiModelBase(attributes) {
    ...
    hiModelBase.prototype.className = function() {
      return this.constructor.name;
    };

    hiModelBase.prototype.id = function() {
      return this.get('id');
    };

    hiModelBase.prototype.get = function(attName) {
      return this._attributes[attName] || this._getRef(attName) || null;
    };

    hiModelBase.prototype.set = function(attName, value) {
      return this._set(attName, value);
    };

    hiModelBase.prototype._set = function(attName, value) {
      if (!attName) {
        return;
      }
    ...
    hiModelBase.prototype.setFields = function(atts) {
    ...
    hiModelBase.prototype._setRef = function(name, obj) {
      var _base;
    ...
    hiModelBase.prototype._getRef = function(name) {
      var _ref;
    ...
    hiModelBase.prototype._loadRefs = function() {
    ...
    hiModelBase.prototype._loadRef = function(name, id, callback) {
    ...
    hiModelBase.prototype.toJSON = function() {
      return JSON.stringify(this._attributes);
    };

    hiModelBase.prototype.toEvent = function() {
    ...
    hiModelBase.prototype.emitTo = function(channel) {
      var _ref, _ref1;
