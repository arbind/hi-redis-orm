...
(function() {
  ...
  */
  ...
  (_base9 = String.prototype).startsWith || (_base9.startsWith = function(needle) {
    return 0 === this.indexOf(needle);
  });

  (_base10 = String.prototype).toCamel || (_base10.toCamel = function() {
    return this.replace(/(\-[a-z,A-Z])/g, function($1) {
      return $1.toUpperCase().replace('-', '');
    });
  });

  (_base11 = String.prototype).toDash || (_base11.toDash = function() {
    return this.replace(/([A-Z])/g, function($1) {
      return "-" + $1.toLowerCase();
    });
  });

  (_base12 = String.prototype).toUnderscore || (_base12.toUnderscore = function() {
    return this.replace(/([A-Z])/g, function($1) {
      return "_" + $1.toLowerCase();
    });
  });

  (_base13 = String.prototype).toTitleCase || (_base13.toTitleCase = function() {
    return this.replace(/(?:^|\s)\w/g, function($1) {
      return $1.toUpperCase();
    });
  });

  (_base14 = String.prototype).toClassName || (_base14.toClassName = function() {
