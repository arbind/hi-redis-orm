...
(function() {
  ...
  ModelBase = (function(_super) {
    ...
    function ModelBase(attributes) {
      ...
      this._setRefORM = __bind(this._setRefORM, this);

      this._setAttORM = __bind(this._setAttORM, this);

      this._getRef = __bind(this._getRef, this);

      this._setRef = __bind(this._setRef, this);

      this._setAtt = __bind(this._setAtt, this);

      this._set = __bind(this._set, this);

      this.setFields = __bind(this.setFields, this);

      this.dbSet = __bind(this.dbSet, this);

      this.dbGet = __bind(this.dbGet, this);
    ...
    ModelBase.prototype.dbGet = function(attName, callback) {
      return this._attributes[attName] || this._getRef(attName) || null;
    };

    ModelBase.prototype.dbSet = function(attName, value, callback) {
      if (!((attName != null) && 'function' === typeof callback)) {
        return;
      }
      if (value instanceof ModelBase) {
        return this._setRefORM(attName, value, callback);
      } else {
        return this._setAttORM(attName, value, callback);
      }
    };
    ...
    ModelBase.prototype._set = function(attName, value) {
      ...
      if (value instanceof ModelBase) {
        this._setRefORM(attName, value, null);
        return this._setRef(attName, value);
      } else {
        this._setAttORM(attName, value, null);
        return this._setAtt(attName, value);
      }
    };

    ModelBase.prototype._setAtt = function(attName, value) {
    ...
    ModelBase.prototype._setAttORM = function(attName, value, callback) {};

    ModelBase.prototype._setRefORM = function(attName, value, callback) {};
